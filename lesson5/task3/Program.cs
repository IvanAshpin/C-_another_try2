//Сделал в последней задаче дополнительно вывод еще одного одномерного массива, состоящий из средних арифметических значений по столбцам двумерного массива.
))
using System;
